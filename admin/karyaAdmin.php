...
// AMBIL DATA KARYA (JOIN dengan struktur_organisasi untuk nama dosen)
...
<head>
  ...
  <style>
    ...
    .type-riset { background-color: #e0e7ff; color: #4361ee; }      /* Biru */
    .type-haki { background-color: #f3e8ff; color: #7e22ce; }       /* Ungu */
    .type-ppm { background-color: #dcfce7; color: #15803d; }        /* Hijau */
    .type-buku { background-color: #ffedd5; color: #c2410c; }       /* Orange */
    .type-default { background-color: #f1f5f9; color: #64748b; }    /* Abu */
