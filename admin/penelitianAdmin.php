...
<head>
  ...
  <title>Manajemen Penelitian | Admin Lab AI</title>
...
<div class="d-flex">
    ...
    <div id="main-content" class="p-4 p-md-5 flex-grow-1" style="min-height: 100vh;">
        ...
        <div class="d-flex justify-content-between align-items-end mb-5">
            <div>
                <h2 class="page-title display-6 mb-1">Manajemen Penelitian</h2>
                <p class="text-muted mb-0">Arsip data riset dan pengembangan Lab AI.</p>
            </div>
            
            <div>
                <a href="tambah_penelitian.php" class="btn btn-primary-custom">
        ...
        <?php if (isset($_GET['hapus'])) { ?>
            <div class="alert alert-custom alert-dismissible fade show p-3 mb-4 d-flex align-items-center" role="alert">
                ...
                <div class="fw-medium">Data penelitian berhasil dihapus.</div>
            ...
            <table class="custom-table">
                <thead>
                    <tr>
                        ...
                        <th width="30%">Peneliti</th>
                        <th width="10%">Tahun</th>
                        <th class="text-center pe-4" width="15%">Menu</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="fw-bold text-dark text-wrap" style="display: block; line-height: 1.5;">
                        ...
                        <td>
                            <div class="d-flex align-items-center text-muted">
                                <i class="bi bi-people-fill me-2 text-primary opacity-50"></i>
                                <span class="fw-medium"><?= htmlspecialchars($p['peneliti']); ?></span>
                            </div>
                        </td>
                        ...
                        <td class="text-center pe-4">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center" href="edit_penelitian.php?id=<?= $p['id']; ?>">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-danger d-flex align-items-center" 
                                           onclick="return confirm('Hapus penelitian ini permanen?')"
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <h6 class="text-muted fw-bold">Belum ada penelitian</h6>
                                <p class="text-muted small">Mulai tambahkan arsip penelitian lab di sini.</p>
                                <a href="tambah_penelitian.php" class="btn btn-sm btn-primary-custom mt-2">Tambah Data</a>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
