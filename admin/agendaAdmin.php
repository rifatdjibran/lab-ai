...
<head>
  ...
  <title>Manajemen Agenda | Admin Lab AI</title>
...
<div class="d-flex">
    ...
    <div id="main-content" class="p-4 p-md-5 flex-grow-1" style="min-height: 100vh;">
        ...
        <div class="d-flex justify-content-between align-items-end mb-5">
            <div>
                <h2 class="page-title display-6 mb-1">Manajemen Agenda</h2>
                <p class="text-muted mb-0">Kelola jadwal kegiatan dan acara Lab AI.</p>
            </div>
            
            <div>
                <a href="tambah_agenda.php" class="btn btn-primary-custom">
        ...
        <?php if (isset($_GET['hapus'])) { ?>
            <div class="alert alert-custom alert-dismissible fade show p-3 mb-4 d-flex align-items-center" role="alert">
                ...
                <div class="fw-medium">Data agenda berhasil dihapus.</div>
                ...
                <tbody>
                    ...
                    if (pg_num_rows($result) > 0) {
                        ...
                        while ($a = pg_fetch_assoc($result)) { 
                            // Logika Status
                            $today = date('Y-m-d');
                            if ($today < $a['tanggal_mulai']) {
                                $statusClass = 'status-upcoming';
                                $statusIcon = 'bi-clock';
                                $statusText = 'Segera';
                            } else if ($today <= $a['tanggal_selesai']) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($a['gambar'])): ?>
                                <img src="../assets/uploads/kegiatan/<?= htmlspecialchars($a['gambar']); ?>" class="table-img" alt="Poster">
                            <?php else: ?>
                        ...
                        <td>
                            <span class="fw-bold text-dark text-wrap" style="display: block; max-width: 250px; line-height: 1.4;">
                        ...
                        <td>
                            <div class="d-flex flex-column">
                                ...
                                <small class="text-muted" style="font-size: 0.75rem;">
                                    s.d <?= date('d M Y', strtotime($a['tanggal_selesai'])); ?>
                                </small>
                            </div>
                        </td>
                        ...
                        <td class="text-center pe-4">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center" href="edit_agenda.php?id=<?= $a['id']; ?>">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-danger d-flex align-items-center" 
                                           ...
                                           href="agendaAdmin.php?delete=<?= $a['id']; ?>">
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5">
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <p class="text-muted small">Tambahkan jadwal kegiatan lab terbaru di sini.</p>
                                <a href="tambah_agenda.php" class="btn btn-sm btn-primary-custom mt-2">Buat Agenda Baru</a>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
