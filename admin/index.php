    ...
    <div class="mt-5">
      <div class="card shadow-sm">
        <div class="card-body">
          ...
          <p>
            Sistem portal Lab AI ini digunakan untuk pengelolaan data seperti berita, fasilitas,
            kegiatan, galeri, publikasi, dan penelitian.
            <br>Gunakan menu di sidebar untuk mengelola konten.
          </p>
        </div>
      </div>
    </div>
